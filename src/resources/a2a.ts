...
export class A2AResource {
	...
	public submitTask(agentId: string, input: A2ASubmitTaskInput): Promise<A2ATaskOutput> {
	...
	public getTask(agentId: string, taskId: string): Promise<A2ATaskOutput> {
		return this.client.request<A2ATaskOutput>(
			"GET",
	...
	public cancelTask(agentId: string, taskId: string): Promise<A2ATaskOutput> {
		return this.client.request<A2ATaskOutput>(
			"POST",
