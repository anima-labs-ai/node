...
export class AnomalyResource {
	...
	public listAlerts(
		orgId: string,
		params?: AnomalyAlertListParams,
		options?: RequestOptions,
	): Promise<PaginatedResponse<AnomalyAlertOutput>> {
	...
	public listRules(
		orgId: string,
		params?: AnomalyRuleListParams,
		options?: RequestOptions,
	): Promise<PaginatedResponse<AnomalyRuleOutput>> {
